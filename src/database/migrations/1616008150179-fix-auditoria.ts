...
export class fixAuditoria1616008150179 implements MigrationInterface {
    name = 'fixAuditoria1616008150179'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `residuo` (`id` int NOT NULL AUTO_INCREMENT, `cantidad` double NULL, `celda` int NOT NULL, `humedad` double NULL, `pH` double NULL, `temperatura` double NULL, `conductividad_electrica` double NULL, `salinidad` double NULL, `tds` double NULL, `status` varchar(8) NOT NULL DEFAULT 'ACTIVE', `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `tipoResiduoId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `ingreso` (`id` int NOT NULL AUTO_INCREMENT, `entrada` datetime NOT NULL, `salida` datetime NULL, `nro_guia` int NOT NULL, `nro_report` int NOT NULL, `status` varchar(8) NOT NULL DEFAULT 'ACTIVE', `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `plantaProcesoId` int NULL, `residuoId` int NULL, `vehiculoId` int NULL, `conductorId` int NULL, UNIQUE INDEX `IDX_0adb2ade3dee33a2705b04170d` (`nro_report`), UNIQUE INDEX `REL_e2362d3264bc33446fe82c27cb` (`residuoId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `transportista_auditoria` (`id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `rut` varchar(255) NOT NULL, `descripcion` varchar(255) NULL, `status_Transportista` varchar(8) NOT NULL DEFAULT 'ACTIVE', `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `idTransportistaId` int NOT NULL, `idUsuarioId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `generador_auditoria` (`id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `rut` varchar(255) NOT NULL, `status_Generador` varchar(8) NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `idGeneradorId` int NOT NULL, `idUsuarioId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `tipo_residuo_auditoria` (`id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `descripcion` varchar(255) NULL, `status_Residuo` varchar(8) NOT NULL DEFAULT 'ACTIVE', `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `idTipoResiduoId` int NOT NULL, `idUsuarioId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `residuo_auditoria` (`id` int NOT NULL AUTO_INCREMENT, `cantidad` double NULL, `celda` int NOT NULL, `humedad` double NULL, `pH` double NULL, `temperatura` double NULL, `conductividad_electrica` double NULL, `salinidad` double NULL, `tds` double NULL, `status_Residuo` varchar(8) NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `idResiduoId` int NOT NULL, `idAuditoriaTipoResiduoId` int NOT NULL, `idUsuarioId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `transportista_auditoria` ADD CONSTRAINT `FK_5141d5b5428f691a6a962457ce8` FOREIGN KEY (`idUsuarioId`) REFERENCES `usuario`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `generador_auditoria` ADD CONSTRAINT `FK_7950cad1dd053f64bdc21e8ccc0` FOREIGN KEY (`idUsuarioId`) REFERENCES `usuario`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `planta_proceso_auditoria` ADD CONSTRAINT `FK_daae8213c68c2cef7d1d1818096` FOREIGN KEY (`idUsuarioId`) REFERENCES `usuario`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `tipo_residuo_auditoria` ADD CONSTRAINT `FK_fc8cc6c690adc1b11d6f671ddfe` FOREIGN KEY (`idUsuarioId`) REFERENCES `usuario`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `residuo_auditoria` ADD CONSTRAINT `FK_b8b10cbfff83c370b038f6282cf` FOREIGN KEY (`idUsuarioId`) REFERENCES `usuario`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `vehiculo_auditoria` ADD CONSTRAINT `FK_3d19ed19652d11a86c8d251f4f8` FOREIGN KEY (`idUsuarioId`) REFERENCES `usuario`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `ingreso_auditoria` ADD CONSTRAINT `FK_425e2476ffe58b24f2dbf9f0cb1` FOREIGN KEY (`idUsuarioId`) REFERENCES `usuario`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `ingreso_auditoria` DROP FOREIGN KEY `FK_425e2476ffe58b24f2dbf9f0cb1`");
        ...
        await queryRunner.query("ALTER TABLE `vehiculo_auditoria` DROP FOREIGN KEY `FK_3d19ed19652d11a86c8d251f4f8`");
        ...
        await queryRunner.query("ALTER TABLE `residuo_auditoria` DROP FOREIGN KEY `FK_b8b10cbfff83c370b038f6282cf`");
        ...
        await queryRunner.query("ALTER TABLE `tipo_residuo_auditoria` DROP FOREIGN KEY `FK_fc8cc6c690adc1b11d6f671ddfe`");
        await queryRunner.query("ALTER TABLE `tipo_residuo_auditoria` DROP FOREIGN KEY `FK_bd2296ff17fc866ecf7033baef0`");
        await queryRunner.query("ALTER TABLE `planta_proceso_auditoria` DROP FOREIGN KEY `FK_daae8213c68c2cef7d1d1818096`");
        ...
        await queryRunner.query("ALTER TABLE `generador_auditoria` DROP FOREIGN KEY `FK_7950cad1dd053f64bdc21e8ccc0`");
        ...
        await queryRunner.query("ALTER TABLE `transportista_auditoria` DROP FOREIGN KEY `FK_5141d5b5428f691a6a962457ce8`");
        ...
        await queryRunner.query("DROP INDEX `IDX_0adb2ade3dee33a2705b04170d` ON `ingreso`");
